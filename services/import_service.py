...
def build_import_preview(conn, xml_path):
    ...
    return {
        "metadata": {
            ...
            "tournament_type": metadata.get("tournament_type"),
            "pairing_system": metadata.get("pairing_system"),
            "acceleration_scheme": metadata.get("acceleration_scheme"),
            "acceleration_rounds": metadata.get("acceleration_rounds"),
            "category_rounds": metadata.get("category_rounds"),
            "mm_bar": metadata.get("mm_bar"),
            "mm_floor": metadata.get("mm_floor"),
            "mm_zero": metadata.get("mm_zero"),
        },
