...
2. Split the largest route and service modules by ownership — in progress.
	...
	- Remaining issue-2 service tasks: move participant listing/materialization and McMahon seed persistence; move pairing orchestration and round/bye state; move match synchronization, result materialization, and deletion; then remove the legacy compatibility bodies after full-suite and import-contract validation.
